// Lista de todos los ejercicios del taller
const EJERCICIOS = [
  ...
  { n: 8, archivo: "pages/ejercicio8.html", titulo: "Descuento por artículo", ciclo: "Para" },
  { n: 9, archivo: "pages/ejercicio9.html", titulo: "Ahorros Bancolombia", ciclo: "Para" },
  { n: 10, archivo: "pages/ejercicio10.html", titulo: "Edad promedio por salón", ciclo: "Para anidado" },
  { n: 11, archivo: "pages/ejercicio11.html", titulo: "Función exponencial e^x", ciclo: "Para" },
  ...
  { n: 16, archivo: "pages/ejercicio16.html", titulo: "Cubo de números naturales", ciclo: "Mientras" },
  { n: 17, archivo: "pages/ejercicio17.html", titulo: "Tabla de multiplicar", ciclo: "Para" },
  { n: 18, archivo: "pages/ejercicio18.html", titulo: "Interés compuesto (1961)", ciclo: "Para" },
...
function construirNav() {
  const paginaActual = normalizarRuta(document.body.dataset.page || "index.html");
  ...
  marca.innerHTML = `
    <a href="../index.html">Ejercicios Repetitivos</a>
    <span>${idxActual >= 0 ? `Ejercicio ${idxActual + 1} de ${EJERCICIOS.length}` : "Menú principal"}</span>
  `;

  if (paginaActual === "index.html") {
    marca.querySelector("a").href = "index.html";
  }
  ...
  inicio.value = paginaActual === "index.html" ? "index.html" : "../index.html";
  inicio.textContent = "Ir al menú";
  select.appendChild(inicio);

  EJERCICIOS.forEach(e => {
    const opt = document.createElement("option");
    opt.value = paginaActual === "index.html"
      ? e.archivo
      : e.archivo.replace("pages/", "");
    opt.textContent = `${e.n}. ${e.titulo}`;

    if (e.archivo === paginaActual) {
      opt.selected = true;
    }
  ...
  if (idxActual > 0) {
    ...
    anterior.href = EJERCICIOS[idxActual - 1].archivo.replace("pages/", "");
  ...
  if (idxActual >= 0 && idxActual < EJERCICIOS.length - 1) {
    ...
    siguiente.href = EJERCICIOS[idxActual + 1].archivo.replace("pages/", "");
